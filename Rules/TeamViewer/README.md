...
#### 使用说明
- TeamViewer.yaml，请使用RULE-SET。
- TeamViewer_Resolve.yaml，请使用RULE-SET。

#### 文件区别
- TeamViewer_Resolve.yaml与TeamViewer.list的区别仅在于后者IP-CIDR(6)类型带no-resolve。
...
https://raw.githubusercontent.com/mowenyun/EgernRules/X/Rules/TeamViewer/TeamViewer.yaml
