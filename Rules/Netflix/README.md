...
#### 使用说明
- Netflix.yaml，请使用RULE-SET。
- Netflix_Resolve.yaml，请使用RULE-SET。

#### 文件区别
- Netflix_Resolve.yaml与Netflix.list的区别仅在于后者IP-CIDR(6)类型带no-resolve。

#### 配置建议
- Netflix.yaml 单独使用。
- Netflix_Resolve.yaml 单独使用。

#### 规则链接
**X分支 (每日更新)**

https://raw.githubusercontent.com/mowenyun/EgernRules/X/Rules/Netflix/Netflix.yaml
