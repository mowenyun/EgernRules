...
#### 使用说明
- ChinaMobile.yaml，请使用RULE-SET。
- ChinaMobile_Resolve.yaml，请使用RULE-SET。

#### 文件区别
- ChinaMobile_Resolve.yaml与ChinaMobile.list的区别仅在于后者IP-CIDR(6)类型带no-resolve。
...
https://raw.githubusercontent.com/mowenyun/EgernRules/X/Rules/ChinaMobile/ChinaMobile.yaml
