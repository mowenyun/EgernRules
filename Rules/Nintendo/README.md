...
#### 使用说明
- Nintendo.yaml，请使用RULE-SET。
- Nintendo_Resolve.yaml，请使用RULE-SET。

#### 文件区别
- Nintendo_Resolve.yaml与Nintendo.list的区别仅在于后者IP-CIDR(6)类型带no-resolve。
...
https://raw.githubusercontent.com/mowenyun/EgernRules/X/Rules/Nintendo/Nintendo.yaml
