...
#### 使用说明
- Opera.yaml，请使用RULE-SET。
- Opera_Resolve.yaml，请使用RULE-SET。

#### 文件区别
- Opera_Resolve.yaml与Opera.list的区别仅在于后者IP-CIDR(6)类型带no-resolve。
...
https://raw.githubusercontent.com/mowenyun/EgernRules/X/Rules/Opera/Opera.yaml
