...
#### 使用说明
- Yandex.yaml，请使用RULE-SET。
- Yandex_Resolve.yaml，请使用RULE-SET。

#### 文件区别
- Yandex_Resolve.yaml与Yandex.list的区别仅在于后者IP-CIDR(6)类型带no-resolve。
...
https://raw.githubusercontent.com/mowenyun/EgernRules/X/Rules/Yandex/Yandex.yaml
