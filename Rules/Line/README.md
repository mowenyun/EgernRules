...
#### 使用说明
- Line.yaml，请使用RULE-SET。
- Line_Resolve.yaml，请使用RULE-SET。

#### 文件区别
- Line_Resolve.yaml与Line.list的区别仅在于后者IP-CIDR(6)类型带no-resolve。
...
https://raw.githubusercontent.com/mowenyun/EgernRules/X/Rules/Line/Line.yaml
