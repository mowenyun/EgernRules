...
#### 使用说明
- LG.yaml，请使用RULE-SET。
- LG_Resolve.yaml，请使用RULE-SET。

#### 文件区别
- LG_Resolve.yaml与LG.list的区别仅在于后者IP-CIDR(6)类型带no-resolve。
...
https://raw.githubusercontent.com/mowenyun/EgernRules/X/Rules/LG/LG.yaml
