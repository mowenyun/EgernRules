...
#### 使用说明
- DNS.yaml，请使用RULE-SET。
- DNS_Resolve.yaml，请使用RULE-SET。

#### 文件区别
- DNS_Resolve.yaml与DNS.list的区别仅在于后者IP-CIDR(6)类型带no-resolve。
...
https://raw.githubusercontent.com/mowenyun/EgernRules/X/Rules/DNS/DNS.yaml
