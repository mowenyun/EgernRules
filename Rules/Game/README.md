...
#### 使用说明
- Game.yaml，请使用RULE-SET。
- Game_Resolve.yaml，请使用RULE-SET。

#### 文件区别
- Game_Resolve.yaml与Game.list的区别仅在于后者IP-CIDR(6)类型带no-resolve。
...
https://raw.githubusercontent.com/mowenyun/EgernRules/X/Rules/Game/Game.yaml
