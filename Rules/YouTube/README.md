...
#### 使用说明
- YouTube.yaml，请使用RULE-SET。
- YouTube_Resolve.yaml，请使用RULE-SET。

#### 文件区别
- YouTube_Resolve.yaml与YouTube.list的区别仅在于后者IP-CIDR(6)类型带no-resolve。
...
https://raw.githubusercontent.com/mowenyun/EgernRules/X/Rules/YouTube/YouTube.yaml
