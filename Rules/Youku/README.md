...
#### 使用说明
- Youku.yaml，请使用RULE-SET。
- Youku_Resolve.yaml，请使用RULE-SET。

#### 文件区别
- Youku_Resolve.yaml与Youku.list的区别仅在于后者IP-CIDR(6)类型带no-resolve。
...
https://raw.githubusercontent.com/mowenyun/EgernRules/X/Rules/Youku/Youku.yaml
