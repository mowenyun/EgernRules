...
#### 使用说明
- EHGallery.yaml，请使用RULE-SET。
- EHGallery_Resolve.yaml，请使用RULE-SET。

#### 文件区别
- EHGallery_Resolve.yaml与EHGallery.list的区别仅在于后者IP-CIDR(6)类型带no-resolve。
...
https://raw.githubusercontent.com/mowenyun/EgernRules/X/Rules/EHGallery/EHGallery.yaml
