...
#### 使用说明
- AmazonIP.yaml，请使用RULE-SET。
- AmazonIP_Resolve.yaml，请使用RULE-SET。

#### 文件区别
- AmazonIP_Resolve.yaml与AmazonIP.list的区别仅在于后者IP-CIDR(6)类型带no-resolve。

#### 配置建议
- AmazonIP.yaml 单独使用。
- AmazonIP_Resolve.yaml 单独使用。

#### 规则链接
**X分支 (每日更新)**

https://raw.githubusercontent.com/mowenyun/EgernRules/X/Rules/AmazonIP/AmazonIP.yaml
