...
#### 使用说明
- Lan.yaml，请使用RULE-SET。
- Lan_Resolve.yaml，请使用RULE-SET。

#### 文件区别
- Lan_Resolve.yaml与Lan.list的区别仅在于后者IP-CIDR(6)类型带no-resolve。
...
https://raw.githubusercontent.com/mowenyun/EgernRules/X/Rules/Lan/Lan.yaml
