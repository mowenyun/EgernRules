...
#### 使用说明
- Facebook.yaml，请使用RULE-SET。
- Facebook_Resolve.yaml，请使用RULE-SET。

#### 文件区别
- Facebook_Resolve.yaml与Facebook.list的区别仅在于后者IP-CIDR(6)类型带no-resolve。
...
https://raw.githubusercontent.com/mowenyun/EgernRules/X/Rules/Facebook/Facebook.yaml
