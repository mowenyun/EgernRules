...
#### 使用说明
- KakaoTalk.yaml，请使用RULE-SET。
- KakaoTalk_Resolve.yaml，请使用RULE-SET。

#### 文件区别
- KakaoTalk_Resolve.yaml与KakaoTalk.list的区别仅在于后者IP-CIDR(6)类型带no-resolve。
...
https://raw.githubusercontent.com/mowenyun/EgernRules/X/Rules/KakaoTalk/KakaoTalk.yaml
